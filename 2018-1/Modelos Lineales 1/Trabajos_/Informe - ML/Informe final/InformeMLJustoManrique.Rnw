...
setwd("D:/Justo Andrés/Dropbox/Maestría en Estadística/2018 - 1/Modelos Lineales 1/Trabajos_/Informe - ML/Informe final/2. Datos/")
...
stargazer(reg_1,reg_2, title = "Comparación entre regresiones lineales múltiples",keep.stat = c("n","rsq","adj.rsq","ser","f","aic"))
@
